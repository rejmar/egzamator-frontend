...
export const getUser = (userId) => {
  return (dispatch) => {
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/user/getUser?userId=" +
          userId
      )
      .then((response) => {
...
export const getTest = (testId) => {
  return (dispatch) => {
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/test/getTest?id=" +
          testId
      )
      .then((response) => {})
      .catch((error) => {});
...
export const addNewTest = (test) => {
  return (dispatch) => {
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/test/addTest",
        test
      )
      .then((response) => {
...
export const getTeacherSubjects = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/subject/getTeacherSubjects?userId=" +
          userId
      )
      .then((response) => {
...
export const getTeacherTests = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/teacher/tests?userId=" +
          userId
      )
      .then((response) => {
...
export const getStudentSubjects = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/subject/getStudentSubjects?userId=" +
          userId
      )
      .then((response) => {
...
export const getStudentTests = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/student/tests?userId=" +
          userId
      )
      .then((response) => {
...
export const getStudentSolvedTests = (userId) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/student/solvedTests?userId=" +
          userId
      )
      .then((response) => {
...
export const addStudentAnswers = (answersData) => {
  return (dispatch) => {
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/test/addAnswers",
        answersData
      )
      .then((response) => {})
      .catch((error) => {});
...
export const deleteTest = (testName, userId) => {
  return (dispatch) => {
    axios
      .get(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/test/remove?testName=" +
          testName
      )
      .then((res) => {
        dispatch(getTeacherTests(userId));
...
export const getStudentsMarks = (subjectName) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "http://egzamator-env.eba-eymix2pk.eu-west-2.elasticbeanstalk.com:8080/egzamator-api/teacher/getStudentsMarks?subjectName=" +
          subjectName
      )
      .then((res) => {
